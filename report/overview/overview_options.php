...
/**
 * Class to store the options for a {@link assignmentques_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignmentques_overview_options extends mod_assignmentques_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('assignmentques_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (assignmentques_has_grades($this->assignmentques)) {
            set_user_preference('assignmentques_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/assignmentques:regrade', 'mod/assignmentques:deleteattempts'), context_module::instance($this->cm->id))
