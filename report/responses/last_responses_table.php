...
/**
 * This file defines the assignmentques responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the assignmentques responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignmentques_last_responses_table extends assignmentques_attempts_report_table {
     ...
     * @param assignmentques_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($assignmentques, $context, $qmsubselect, assignmentques_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-assignmentques-report-responses-report', $assignmentques, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->assignmentques->id . '&amp;attempt=' .
