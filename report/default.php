...
/**
 * Base class for assignmentques report plugins.
 *
 ...
 * This class displays assignmentques reports.  Because it is called from
 * within /mod/assignmentques/report.php you can assume that the page header
 * and footer are taken care of.
 *
 * This file can refer to itself as report.php to pass variables
 * to itself - all these will also be globally available.  You must
 * pass "id=$cm->id" or q=$assignmentques->id", and "mode=reportname".
 *
 * @copyright 1999 onwards Martin Dougiamas and others {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class assignmentques_default_report {
    const NO_GROUPS_ALLOWED = -2;

    /**
     * Override this function to displays the report.
     * @param $cm the course-module for this assignmentques.
     * @param $course the coures we are in.
     * @param $assignmentques this assignmentques.
     */
    public abstract function display($cm, $course, $assignmentques);
    ...
    public function print_header_and_tabs($cm, $course, $assignmentques, $reportmode = 'overview') {
        ...
        $PAGE->set_title($assignmentques->name);
