...
/**
 * Standard plugin entry points of the assignmentques statistics report.
 *
 ...
 * @package  assignmentques_statistics
 * @category files
 * @param context $previewcontext the assignmentques context
 ...
 */
function assignmentques_statistics_question_preview_pluginfile($previewcontext, $questionid,
    ...
    require_capability('assignmentques/statistics:view', $context);
