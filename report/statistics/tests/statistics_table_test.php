...
/**
 * Unit tests for the assignmentques_statistics_table class.
 *
...
/**
 * Class assignmentques_statistics_statistics_table_testcase
 *
 * @copyright  2018 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignmentques_statistics_statistics_table_testcase extends advanced_testcase {

    public function test_format_percentage() {
        $table = new assignmentques_statistics_table();

        // The format_percentage method is protected. Use Reflection to call the method.
        $reflector = new ReflectionClass('assignmentques_statistics_table');
