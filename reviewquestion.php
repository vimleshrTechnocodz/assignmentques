...
$baseurl = new moodle_url('/mod/assignmentques/reviewquestion.php',
...
$PAGE->set_title(get_string('reviewofquestion', 'assignmentques', array(
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'assignmentques'));
        die();
...
// Other attempts at the assignmentques.
