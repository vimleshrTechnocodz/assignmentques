...
/**
 * This page deals with processing responses during an attempt at a assignmentques.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_assignmentques_exception($attemptobj->get_assignmentquesobj(),
