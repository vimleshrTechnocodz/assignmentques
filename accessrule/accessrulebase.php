...
/**
 * Base class for rules that restrict the ability to attempt a assignmentques.
 *
...
/**
 * A base class that defines the interface for the various assignmentques access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class assignmentques_access_rule_base {
    /** @var stdClass the assignmentques settings. */
    protected $assignmentques;
    /** @var assignmentques the assignmentques object. */
    protected $assignmentquesobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular assignmentques.
     * @param assignmentques $assignmentquesobj information about the assignmentques in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($assignmentquesobj, $timenow) {
        $this->assignmentquesobj = $assignmentquesobj;
        $this->assignmentques = $assignmentquesobj->get_assignmentques();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given assignmentques, otherwise return null.
     * @param assignmentques $assignmentquesobj information about the assignmentques in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/assignmentques:ignoretimelimits capability.
     * @return assignmentques_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_assignmentques_preflight_check_form $assignmentquesform the form being built.
    ...
    /**
     * This is called when the current attempt at the assignmentques is finished. This is
    ...
    /**
     * Information, such as might be shown on the assignmentques view page, relating to this restriction.
     ...
     * this assignmentques, then return true. This is used so we can know whether to display a
     ...
     * attempt at this assignmentques.
     */
    ...
    /**
     * Add any fields that this rule requires to the assignmentques settings form. This
     * method is called from {@link mod_assignmentques_mod_form::definition()}, while the
    ...
    /**
     * Save any submitted settings when the assignmentques settings form is submitted. This
     * is called from {@link assignmentques_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the assignmentques is deleted. This is called
     * from {@link assignmentques_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link assignmentques_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $assignmentquesid the id of the assignmentques we are loading settings for. This
     *     can also be accessed as assignmentques.id in the SQL. (assignmentques is a table alisas for {assignmentques}.)
     ...
     */
    public static function get_settings_sql($assignmentquesid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($assignmentquesid) {
        return array();
    }
}
