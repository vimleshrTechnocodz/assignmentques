...
/**
 * Strings for the assignmentquesaccess_timelimit plugin.
 *
...
$string['pluginname'] = 'Time limit assignmentques access rule';
$string['privacy:metadata'] = 'The Time limit assignmentques access rule plugin does not store any personal data.';
$string['assignmentquestimelimit'] = 'Time limit: {$a}';
