YUI.add('moodle-mod_assignmentques-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_assignmentques-questionchooser'
});

M.mod_assignmentques = M.mod_assignmentques || {};
M.mod_assignmentques.init_questionchooser = function() {
    M.mod_assignmentques.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_assignmentques.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_assignmentques-util", "querystring-parse"]});
