YUI.add('moodle-mod_assignmentques-assignmentquesbase', function (Y, NAME) {

/**
 * The assignmentquesbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_assignmentques-assignmentquesbase
 */
var ASSIGNMENTQUESBASENAME = 'mod_assignmentques-assignmentquesbase';

var ASSIGNMENTQUESBASE = function() {
    ASSIGNMENTQUESBASE.superclass.constructor.apply(this, arguments);
};
 ...
 * @constructor
 */
Y.extend(ASSIGNMENTQUESBASE, Y.Base, {
    // Registered Modules
    registermodules: [],
 ...
 */
M.mod_assignmentques.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_assignmentques.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
