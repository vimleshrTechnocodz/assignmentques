YUI.add('moodle-mod_assignmentques-dragdrop', function (Y, NAME) {

/* eslint-disable no-unused-vars */
/**
 * Drag and Drop for Assignmentques sections and slots.
 *
 * @module moodle-mod-assignmentques-dragdrop
 */
...
var CSS = {
    ...
    CONTENT: 'content',
    COURSECONTENT: 'mod-assignmentques-edit-content',
 ...
 *
 * @class M.mod_assignmentques.dragdrop.section
 * @constructor
...
Y.extend(DRAGSECTION, M.core.dragdrop, {
    ...
    initializer: function() {
        ...
        if (this.sectionlistselector) {
            ...
            del.dd.plug(Y.Plugin.DDConstrained, {
                // Keep it inside the .mod-assignmentques-edit-content
    ...
    drop_hit: function(e) {
        ...
        if (dragnodeid === dropnodeindex) {
            Y.log("Skipping move - same location moving " + dragnodeid + " to " + dropnodeindex,
                  'debug', 'moodle-mod_assignmentques-dragdrop');
            return;
        }

        Y.log("Moving from position " + dragnodeid + " to position " + dropnodeindex, 'debug', 'moodle-mod_assignmentques-dragdrop');
        ...
        params.assignmentquesid = this.get('assignmentquesid');
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        M.mod_assignmentques.edit.process_sections(Y, sectionlist, responsetext, loopstart, loopend);
                    } catch (e) {
                        // Ignore.
                    }
                    ...
                    do {
                        ...
                        for (index = loopstart; index <= loopend; index++) {
                            if (Y.Moodle.core_course.util.section.getId(sectionlist.item(index - 1)) >
                                ...
                                M.mod_assignmentques.edit.swap_sections(Y, index - 1, index);
    ...
    NAME: 'mod_assignmentques-dragdrop-section',
    ATTRS: {
        courseid: {
            value: null
        },
...
M.mod_assignmentques.init_section_dragdrop = function(params) {
...
Y.extend(DRAGRESOURCE, M.core.dragdrop, {
    initializer: function() {
        ...
        M.mod_assignmentques.dragres = this;
    },
    ...
    setup_for_section: function() {
        Y.Node.all('.mod-assignmentques-edit-content ul.slots ul.section').each(function(resources) {
    ...
    drop_hit: function(e) {
        ...
        params.field = 'move';
        params.id = Number(Y.Moodle.mod_assignmentques.util.slot.getId(dragnode));
        ...
        if (previousslot) {
            params.previousid = Number(Y.Moodle.mod_assignmentques.util.slot.getId(previousslot));
        }

        var previouspage = dragnode.previous(SELECTOR.PAGE);
        if (previouspage) {
            params.page = Number(Y.Moodle.mod_assignmentques.util.page.getId(previouspage));
        }
        ...
        Y.io(uri, {
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    M.mod_assignmentques.assignmentquesbase.invoke_function('set_visibility_resource_ui', params);
                    this.unlock_drag_handle(drag, CSS.EDITINGMOVE);
                    window.setTimeout(function() {
                        spinner.hide();
                    }, 250);
                    M.mod_assignmentques.resource_toolbox.reorganise_edit_page();
                },
                failure: function(tid, response) {
                    this.ajax_failure(response);
    ...
    NAME: 'mod_assignmentques-dragdrop-resource',
    ATTRS: {
        courseid: {
            value: null
        },
...
M.mod_assignmentques = M.mod_assignmentques || {};
M.mod_assignmentques.init_resource_dragdrop = function(params) {
    ...
    "requires": [
        ...
        "moodle-mod_assignmentques-util-base",
        "moodle-mod_assignmentques-util-page",
