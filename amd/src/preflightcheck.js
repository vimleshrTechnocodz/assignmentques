 ...
 *
 * This is also responsible for opening the pop-up window, if the assignmentques requires to be in one.
 *
 * @module    mod_assignmentques/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_assignmentques/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the assignmentques should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_assignmentques_preflight_popup']
                    });
                ...
                if (popupoptions) {
                    Y.one(finalStartButton).on('click', t.launchAssignmentquesPopup, t, popupoptions);
                }
            });
        },
        ...
        /**
         * Event handler for the assignmentques start attempt button.
          * @param {Event} e the event being responded to
          * @param {Object} popupoptions
         */
        launchAssignmentquesPopup: function(e, popupoptions) {
            e.halt();
            Y.use('moodle-core-formchangechecker', 'io-form', function() {
                ...
                window.openpopup(e, {
                    ...
                    windowname: 'assignmentquespopup',
