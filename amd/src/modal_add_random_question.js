 ...
 *
 * @module     mod_assignmentques/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_assignmentques-assignmentques-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_assignmentques/modal_add_random_question'
        );
