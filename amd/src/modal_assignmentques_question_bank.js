 ...
 *
 * @module     mod_assignmentques/modal_assignmentques_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_ASSIGNMENTQUES_CONTAINER: 'td.addtoassignmentquesaction',
        ANCHOR: 'a[href]',
     ...
     */
    var ModalAssignmentquesQuestionBank = function(root) {
    ...
    ModalAssignmentquesQuestionBank.TYPE = 'mod_assignmentques-assignmentques-question-bank';
    ModalAssignmentquesQuestionBank.prototype = Object.create(Modal.prototype);
    ModalAssignmentquesQuestionBank.prototype.constructor = ModalAssignmentquesQuestionBank;
     ...
     * @param {int} id
     */
    ModalAssignmentquesQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalAssignmentquesQuestionBank.prototype.getContextId = function() {
        return this.contextId;
    };

    /**
     * Set the id of the page that the question should be added to
     * when the user clicks the add to assignmentques link.
     *
     * @method setAddOnPageId
     * @param {int} id
     */
    ModalAssignmentquesQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalAssignmentquesQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalAssignmentquesQuestionBank.prototype.show = function() {
     ...
     */
    ModalAssignmentquesQuestionBank.prototype.reloadBodyContent = function(queryString) {
        // Load the question bank fragment to be displayed in the modal.
        var promise = Fragment.loadFragment(
            'mod_assignmentques',
            'assignmentques_question_bank',
            this.getContextId(),
            {
     ...
     *
     * @method handleAddToAssignmentquesEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalAssignmentquesQuestionBank.prototype.handleAddToAssignmentquesEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalAssignmentquesQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalAssignmentquesQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     *      - The assignmentques category select box
     ...
     */
    ModalAssignmentquesQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalAssignmentquesQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('submit', SELECTORS.ADD_QUESTIONS_FORM, function(e) {
            // If the user clicks on the "Add selected questions to the assignmentques" button to add some questions to the page
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to assignmentques link.
            if (anchorElement.closest(SELECTORS.ADD_TO_ASSIGNMENTQUES_CONTAINER).length) {
                this.handleAddToAssignmentquesEvent(e, anchorElement);
                return;
            }
    ...
    return ModalAssignmentquesQuestionBank;
});
