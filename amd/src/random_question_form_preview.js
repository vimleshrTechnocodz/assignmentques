 ...
 *
 * @module    mod_assignmentques/random_question_form_preview
...
define(
    ...
    var TEMPLATE_NAME = 'mod_assignmentques/random_question_form_preview_question_list';
    var SELECTORS = {
    ...
    var renderQuestionCount = function(root, questionCount) {
        Str.get_string('questionsmatchingfilter', 'mod_assignmentques', questionCount)
