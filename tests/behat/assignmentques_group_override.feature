...
Feature: Assignmentques group override
  In order to grant a group special access to a assignmentques
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assignmentques     | Test assignmentques | Test assignmentques description | C1     | assignmentques1    | 1         |

  Scenario: Override Group 1 as teacher of Group 1
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test assignmentques" "mod_assignmentques > Group overrides" page logged in as "teacher1"
  ...
  Scenario: Override Group 1 as teacher in no group
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test assignmentques" "mod_assignmentques > Group overrides" page logged in as "teacher3"
  ...
  Scenario: A teacher with accessallgroups permission should see all group overrides
    When I am on the "Test assignmentques" "mod_assignmentques > Group overrides" page logged in as "admin"
    And I press "Add group override"
    ...
    And I press "Save"
    And I log out
    And I am on the "Test assignmentques" "mod_assignmentques > Group overrides" page logged in as "teacher1"
