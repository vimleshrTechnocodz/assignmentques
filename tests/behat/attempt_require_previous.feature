...
Feature: Attempt a assignmentques where some questions require that the previous question has been answered.
  In order to complete a assignmentques where questions require previous ones to be complete
  As a student
  ...
  Scenario: A question that requires the previous one is initally blocked
    ...
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    | immediatefeedback  |
    ...
    And I log out
    And I am on the "Assignmentques 1 > student > Attempt 1" "mod_assignmentques > Attempt review" page logged in as "teacher"
  ...
  @javascript
  Scenario: After assignmentques submitted, all questions show on the review page
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
  ...
  @javascript
  Scenario: A questions cannot be blocked in a deferred feedback assignmentques (despite what is set in the DB).
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
    And the following "activities" exist:
      | activity   | name   | intro              | course | idnumber | preferredbehaviour |
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    | deferredfeedback   |
    And assignmentques "Assignmentques 1" contains the following questions:
      | question | page | requireprevious |
      | TF1      | 1    | 0               |
      | TF2      | 1    | 1               |
  ...
  Scenario: Questions cannot be blocked in a shuffled section (despite what is set in the DB).
    ...
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    | immediatefeedback  | 2                |
    And assignmentques "Assignmentques 1" contains the following questions:
      | question | page | requireprevious |
      | TF1      | 1    | 1               |
      | TF2      | 2    | 1               |
  ...
  @javascript
  Scenario: A questions cannot be blocked in sequential assignmentques (despite what is set in the DB).
    Given the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF1   | First question  |
      | Test questions   | truefalse   | TF2   | Second question |
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    | immediatefeedback  | sequential |
    And assignmentques "Assignmentques 1" contains the following questions:
      | question | page | requireprevious |
      | TF1      | 1    | 1               |
      | TF2      | 1    | 1               |
