...
Feature: Adding random questions to a assignmentques based on category and tags
  ...
  Scenario: A random question can be added to the assignmentques
    Given I am on the "Assignmentques 1" "mod_assignmentques > Edit" page logged in as "teacher1"
    When I open the "last" add to assignmentques menu
    And I follow "a random question"
    And I set the field "Tags" to "foo"
    And I press "Add random question"
    Then I should see "Random (Questions Category 1, tags: foo)" on assignmentques page "1"
