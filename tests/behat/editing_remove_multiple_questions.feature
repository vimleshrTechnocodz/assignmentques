...
Feature: Edit assignmentques page - remove multiple questions
  In order to change the layout of a assignmentques I built efficiently
  As a teacher
  ...
  # Confirm the starting point.
    Then I should see "Question A" on assignmentques page "1"
    And I should see "Question B" on assignmentques page "2"
    And I should see "Question C" on assignmentques page "2"
    And I should see "Total of marks: 3.00"
    And I should see "Questions: 3"
    And I should see "This assignmentques is open"
  ...
  # Delete first question in first page. Page contains multiple questions. No reordering.
    ...
    Then I should not see "Question A" on assignmentques page "1"
    And I should see "Question B" on assignmentques page "1"
  ...
  Scenario: Delete all questions by checking select all.
    ...
    Then I should not see "Question A" on assignmentques page "1"
    And I should not see "Question B" on assignmentques page "1"
    And I should not see "Question C" on assignmentques page "2"
  ...
  Scenario: Delete multiple questions from sections
    ...
    Then I should see "Question A" on assignmentques page "1"
    And I should see "Question B" on assignmentques page "2"
    And I should see "Question D" on assignmentques page "3"
