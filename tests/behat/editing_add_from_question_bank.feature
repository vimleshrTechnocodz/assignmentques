...
Feature: Adding questions to a assignmentques from the question bank
  ...
  Scenario: Questions are added in the right place with multiple sections
    ...
    And I log in as "teacher1"
    And I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    When I open the "Page 1" add to assignmentques menu
    And I follow "from question bank"
    And I set the field with xpath "//tr[contains(normalize-space(.), 'question 03 name')]//input[@type='checkbox']" to "1"
    And I click on "Add selected questions to the assignmentques" "button"
    Then I should see "question 03 name" on assignmentques page "1"
    And I should see "question 01 name" before "question 03 name" on the edit assignmentques page
