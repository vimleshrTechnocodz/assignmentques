...
Feature: Teachers can override the grade for any question
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    | 20    |
    And assignmentques "Assignmentques 1" contains the following questions:
      | question | page |
      | TF1      | 1    |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I am on the "Assignmentques 1" "mod_assignmentques > View" page
  ...
  Scenario: Validating the marking of an essay question attempt.
    ...
    And I am on the "Assignmentques 1 > student1 > Attempt 1" "mod_assignmentques > Attempt review" page
  ...
  Scenario: Comment on a response to an essay question attempt.
    ...
    And I upload "mod/assignmentques/tests/fixtures/moodle_logo.jpg" file to "Files" filemanager
