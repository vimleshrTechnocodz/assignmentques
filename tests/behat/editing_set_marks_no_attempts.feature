...
Feature: Edit assignmentques marks with no attempts
  In order to create a assignmentques that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit assignmentques page.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | C1     | assignmentques1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Assignmentques 1" assignmentques with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the assignmentques settings say it should be.
