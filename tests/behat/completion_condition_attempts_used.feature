...
Feature: Set a assignmentques to be marked complete when the student uses all attempts allowed
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a assignmentques to complete when the student receives a passing grade, or completed_fail if they use all attempts without passing
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assignmentques     | Test assignmentques name | C1     | assignmentques1    | 2        | 5.00      | 2          | 1                  | 1              | 1                           |
  ...
  Scenario: student1 uses up both attempts without passing
    ...
    And I press "Re-attempt assignmentques"
