...
Feature: Edit assignmentques page - section headings
  In order to build a assignmentques laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a assignmentques with one default section
    ...
    And assignmentques "Assignmentques 1" contains the following questions:
      ...
      | TF2      | 2    |
      | TF3      | 3    |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
  ...
  Scenario: Modify the default section headings
    Given the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I change assignmentques section heading "" to "This is section one"
  ...
  Scenario: Modify section headings
    ...
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I change assignmentques section heading "" to "This is section one"
    And I change assignmentques section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: Set section headings to blanks
    ...
    When I change assignmentques section heading "Heading 1" to ""
    Then I should not see "Heading 1"
    And I should see "Heading 2"
    And I should see "Heading 3"

    And I change assignmentques section heading "Heading 2" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
    And I should see "Heading 3"

    And I change assignmentques section heading "Heading 3" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And assignmentques "Assignmentques 1" contains the following sections:
      ...
      | Heading 2 | 2         | 0       |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I change assignmentques section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And assignmentques "Assignmentques 1" contains the following sections:
      ...
      | Heading 3 | 5         | 1       |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I move "TF5" to "After Question 2" in the assignmentques by clicking the move icon
    Then I should see "TF5" on assignmentques page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And assignmentques "Assignmentques 1" contains the following sections:
      ...
      | Heading 3 | 5         | 1       |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I move "TF1" to "After Question 3" in the assignmentques by clicking the move icon
    Then I should see "TF1" on assignmentques page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the assignmentques.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | assignmentques       | Assignmentques 1 | Assignmentques 1 description | C1     | assignmentques1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And assignmentques "Assignmentques 1" contains the following sections:
      ...
      | Heading 3 | 3         | 0       |
    When I am on the "Assignmentques 1" "mod_assignmentques > Edit" page
    And I click on shuffle for section "Heading 1" on the assignmentques edit page
    And I click on shuffle for section "Heading 2" on the assignmentques edit page
    Then shuffle for section "Heading 1" should be "On" on the assignmentques edit page
    And shuffle for section "Heading 2" should be "On" on the assignmentques edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the assignmentques edit page
    And I click on shuffle for section "Heading 2" on the assignmentques edit page
    Then shuffle for section "Heading 1" should be "Off" on the assignmentques edit page
    And shuffle for section "Heading 2" should be "Off" on the assignmentques edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the assignmentques edit page
    And shuffle for section "Heading 2" should be "Off" on the assignmentques edit page
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I open the "Page 2" add to assignmentques menu
  ...
  Scenario: Add section works after removing a page break with more than 10 pages
    ...
    And I open the "Page 10" add to assignmentques menu
    And I choose "a new section heading" in the open action menu
