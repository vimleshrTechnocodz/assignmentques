...
Feature: Edit assignmentques marks with attempts
  In order to create a assignmentques that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit assignmentques page (even after the assignmentques has been attempted).
