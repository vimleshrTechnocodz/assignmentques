...
Feature: Settings form fields disabled if not required
  In to create assignmentqueszes as simply as possible
  As a teacher
  ...
  Scenario: Depending on the number of attempts, different form fields are disabled.
    When I add a "Assignmentques" to section "1"
    And I expand all fieldsets
    And I set the field "Name" to "Test assignmentques"
    ...
    And I set the following fields to these values:
        ...
        | Attempts allowed | 3        |
    And I press "Save"
    And I follow "Test assignmentques"
