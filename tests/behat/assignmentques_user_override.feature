...
Feature: Assignmentques user override
  In order to grant a student special access to a assignmentques
  As a teacher
  ...
  Scenario: Add, modify then delete a user override
    ...
    When I follow "Assignmentques 1"
  ...
  @javascript
  Scenario: Being able to modify a user override when the assignmentques is not available to the student
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
  ...
  Scenario: A teacher without accessallgroups permission should only be able to add user override for users that he/she shares groups with,
    ...
    And the following "activities" exist:
      ...
      | assignmentques     | Assignmentques 2 | Assignmentques 2 description | C1     | assignmentques2    | 1         |
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Assignmentques 2"
    And I navigate to "User overrides" in current page administration
    And I press "Add user override"
