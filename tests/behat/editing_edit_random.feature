@mod @mod_assignmentques @javascript
Feature: Editing random questions already in a assignmentques based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assignmentques       | Assignmentques 1 | Assignmentques 1 for testing the Add random question form | C1     | assignmentques1    |
  ...
  Scenario: Editing tags on one slot does not delete the rest
    Given I am on the "Assignmentques 1" "mod_assignmentques > Edit" page logged in as "teacher1"
    ...
    Then I should see "Random (Questions Category 1, tags: essay)" on assignmentques page "1"
    And I should see "Random (Questions Category 1, tags: hard)" on assignmentques page "2"
