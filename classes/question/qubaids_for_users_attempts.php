...
/**
 * A {@link qubaid_condition} representing all the attempts by one user at a given assignmentques.
 *
...
namespace mod_assignmentques\question;
...
class qubaids_for_users_attempts extends \qubaid_join {
     ...
     * Constructor.
     *
     * This takes the same arguments as {@link assignmentques_get_user_attempts()}.
     *
     ...
     */
    public function __construct($assignmentquesid, $userid, $status = 'finished', $includepreviews = false) {
        $where = 'assignmentquesa.assignmentques = :assignmentquesaassignmentques AND assignmentquesa.userid = :userid';
        $params = array('assignmentquesaassignmentques' => $assignmentquesid, 'userid' => $userid);
