...
namespace mod_assignmentques\form;
...
class randomquestion_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('advcheckbox', 'includesubcategories', get_string('recurse', 'assignmentques'), null, null, array(0, 1));
        ...
        if ($defaultvalues->fromtags) {
            ...
            foreach ($defaultvalues->fromtags as $fromtag) {
                if (!$fromtagselement->optionExists($fromtag)) {
                    $optionname = get_string('randomfromunavailabletag', 'mod_assignmentques', explode(',', $fromtag)[1]);
