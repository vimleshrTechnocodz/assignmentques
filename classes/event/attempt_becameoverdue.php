...
/**
 * The mod_assignmentques attempt became overdue event.
 *
...
/**
 * The mod_assignmentques attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The assignmentques attempt with id '$this->objectid' belonging to the assignmentques with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventassignmentquesattempttimelimitexceeded', 'mod_assignmentques');
    }
    ...
    static public function get_legacy_eventname() {
        return 'assignmentques_attempt_overdue';
    }
