...
/**
 * The mod_assignmentques attempt summary viewed event.
 *
...
/**
 * The mod_assignmentques attempt summary viewed event class.
 *
...
class attempt_summary_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptsummaryviewed', 'mod_assignmentques');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the summary for the attempt with id '$this->objectid' belonging " .
            "to the user with id '$this->relateduserid' for the assignmentques with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/assignmentques/summary.php', array('attempt' => $this->objectid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'assignmentques', 'view summary', 'summary.php?attempt=' . $this->objectid,
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['assignmentquesid'])) {
            throw new \coding_exception('The \'assignmentquesid\' must be set in other.');
        }
    }
