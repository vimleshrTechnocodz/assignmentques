...
/**
 * The mod_assignmentques attempt viewed event.
 *
...
/**
 * The mod_assignmentques attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_assignmentques');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'assignmentques', 'continue attempt', 'review.php?attempt=' . $this->objectid,
