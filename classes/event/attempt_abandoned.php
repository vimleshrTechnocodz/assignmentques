...
/**
 * The mod_assignmentques attempt abandoned event.
 *
...
/**
 * The mod_assignmentques attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int assignmentquesid: (optional) id of the assignmentques.
 * }
 *
 * @package    mod_assignmentques
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the assignmentques with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassignmentquesattemptabandoned', 'mod_assignmentques');
    }
    ...
    static public function get_legacy_eventname() {
        return 'assignmentques_attempt_abandoned';
    }
